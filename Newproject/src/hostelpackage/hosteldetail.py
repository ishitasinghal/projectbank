#vatika girls hostel
def vatika_girls():
    from hostelpackage import hosteldetails2
...
Email: vatikagirls@gmail.com'''
    hosteldetails2.obj1.select(name,about,rooms,transport,price,facilities,book_now)
...
Email: vatikaboys@gmail.com'''
    hosteldetails2.obj2.select(name,about,rooms,transport,price,facilities,book_now)
...
Email: amanresidency@gmail.com'''
    hosteldetails2.obj3.select(name,about,rooms,transport,price,facilities,book_now)
...
Email: sarthak@gmail.com'''
    hosteldetails2.obj4.select(name,about,rooms,transport,price,facilities,book_now)
...
Email: pride@gmail.com'''
    hosteldetails2.obj5.select(name,about,rooms,transport,price,facilities,book_now)
